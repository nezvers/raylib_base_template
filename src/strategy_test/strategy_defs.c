...
static const BuildingDef buildingDefs[BLD_COUNT] = {
    ...
    [BLD_TOWN_HALL] = {
        ...
        .maxHp = 300.0f, .buildTime = 8.0f, .critical = true, .popCap = 4,
